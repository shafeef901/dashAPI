...
$status = false;
$list = mysql_query("SELECT * FROM `d_polls` WHERE 1 ORDER BY `pollId` DESC");



while($polls = mysql_fetch_assoc($list)){

		$responseCount = mysql_fetch_assoc(mysql_query("SELECT COUNT(`pollId`) AS total FROM `d_pollresponses` WHERE `pollId`= '{$polls['pollId']}'"));
